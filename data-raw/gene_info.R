...
temp <- tempfile()
download.file("https://www.proteinatlas.org/download/proteinatlas.tsv.zip",temp)
...
write.table(gene_info, file = "data-raw/gene_info.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
