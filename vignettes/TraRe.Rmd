...
genes) and 121 filtered samples. Patients from this clinical case were treated with 
...
* Run LINKER using the complete data, 12971 genes and 121 samples, to generate all possible modules (GRN).
