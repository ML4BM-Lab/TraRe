...
# knitr::include_graphics(path="./mod_sim.VBSR.1.dendro.png")
```
...
# knitr::include_graphics(path="./mod_sim.VBSR.1.heatm.png")
```
...
# knitr::include_graphics(path="./igraphs.raw.full_graph.png")
```
